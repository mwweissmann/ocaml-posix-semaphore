...
(* OASIS_START *)
(* DO NOT EDIT (digest: a591bfb0c3c9e674a51bf3311e5272b2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some "https://github.com/mwweissmann/ocaml-posix-semaphore/";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["semaphore.c"; "ocaml-posix-semaphore.h"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                      ...
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-lrt"; "-lpthread"])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for POSIX semaphore";
                      doc_authors = [];
                      doc_abstract = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "posix-semaphore"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\246\023\199nh5\200\170v\005\195\216g0\231\134";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
